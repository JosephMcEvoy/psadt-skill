...
- 60000 - 68999: Reserved for built-in exit codes
...
$adtSession = @{
    ...
    AppProcessesToClose = @(
        # @{ Name = 'processname'; Description = 'Application Display Name' }
    )
...
function Install-ADTDeployment
{
    ...
    ## Show Welcome Message, close processes if required, allow up to 3 deferrals.
    $saiwParams = @{
